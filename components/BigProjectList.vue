<template>
  <div class="project-wrapper large">
    <div class="block-project" v-for="project in projects" :key="project.id">
      <FormattedImage class="project-img" :field="project.data.header" :width="800" :height="600" />
